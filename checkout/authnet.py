...
def do_auth_capture(amount='0.00', card_num=None, exp_date=None, card_cvv=None):
    ...
    """
    # When the results of the transaction is returned, it is separated by the delimiter we specify
    delimiter = '|'
    # Specifies all the parameters that'll be posted with the request
    ...
    # This URL-encode the parameters for the post request
